...
/**@file   cons_distinguishedrep.h
 * @ingroup CONSHDLRS
 * @brief  constraint handler for distinguishedrep constraints
 * @author James Cussens
 */

/*---+----1----+----2----+----3----+----4----+----5----+----6----+----7----+----8----+----9----+----0----+----1----+----2*/

#ifndef __SCIP_CONS_DISTINGUISHEDREP_H__
#define __SCIP_CONS_DISTINGUISHEDREP_H__
